				...
				class Motile : public robochart::State 
				{
					public:
						...
						void Entry()
						{
							...
							{
								S_LTin_State_Machine->probabilityOfAdhesion = Random_Walk();
							}
						}
					private:
						std::shared_ptr<LTin_Step> R_LTin_Step;
			...
			public:
				class Disassociated : public robochart::State 
				{
					public:
						...
						void Entry()
						{
							R_LTin_Step->disassociate_cells();
							S_LTin_State_Machine->move_finished = true;
							S_LTin_State_Machine->contactedCell = false;
						}
					private:
						std::shared_ptr<LTin_Step> R_LTin_Step;
						std::shared_ptr<LTin_Controller> C_LTin_Controller;
			...
			public:
				class t2 : public robochart::Transition {
					...
					public:
						...
						{}
						bool Condition() {
							if (S_LTin_State_Machine->contactedCell == true) {
								#ifdef SM_DEBUG
			...
			public:
				class t4 : public robochart::Transition {
					...
					public:
						...
						{}
						bool Condition() {
							if (S_LTin_State_Machine->contactedCell == false && S_LTin_State_Machine->move_finished == false) {
								#ifdef SM_DEBUG
				...
				class Adhered : public robochart::State 
				{
					public:
						...
						void Entry()
						{
							if (S_LTin_State_Machine->move_finished == false) 
							{
								S_LTin_State_Machine->probabilityOfAdhesion = calculate_adhesion_probability();
							}
						}
					private:
						std::shared_ptr<LTin_Step> R_LTin_Step;
		...
		public:
			class t1 : public robochart::Transition {
				...
				public:
					...
					{}
					bool Condition() {
						if (S_LTin_State_Machine->contactedCell == false && R_LTin_Step->chemokine_in_environment == false && S_LTin_State_Machine->T->GetCounter() > 0) {
							#ifdef SM_DEBUG
		...
		public:
			class t3 : public robochart::Transition {
				...
				public:
					...
					{}
					bool Condition() {
						if (S_LTin_State_Machine->contactedCell == true && S_LTin_State_Machine->adhered == true && S_LTin_State_Machine->T->GetCounter() > 0) {
							#ifdef SM_DEBUG
		...
		public:
			class t2 : public robochart::Transition {
				...
				public:
					...
					{}
					bool Condition() {
						if (S_LTin_State_Machine->contactedCell == true && S_LTin_State_Machine->T->GetCounter() > 0) {
							#ifdef SM_DEBUG
		...
		public:
			class t4 : public robochart::Transition {
				...
				public:
					...
					{}
					bool Condition() {
						if (S_LTin_State_Machine->contactedCell == false && S_LTin_State_Machine->T->GetCounter() > 0) {
							#ifdef SM_DEBUG
