...
LTin_State_Machine::LTin_State_Machine(
			...
			std::shared_ptr<LTin_Controller> C_LTin_Controller) :R_LTin_Step(R_LTin_Step), C_LTin_Controller(C_LTin_Controller), StateMachine("LTin_State_Machine"), move_finished(false), adhered(false), contactedCell(false), probabilityOfAdhesion(0)
{
