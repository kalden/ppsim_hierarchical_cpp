...
LTi_State_Machine::LTi_State_Machine(
			...
			std::shared_ptr<LTiController> C_LTiController) :R_LTiStep(R_LTiStep), C_LTiController(C_LTiController), StateMachine("LTi_State_Machine"), move_finished(false), adhered(false), contactedCell(false), probabilityOfAdhesion(0), chemokine_response_probability(0)
{
	...
	std::shared_ptr<t10> S_LTi_State_Machine_t10 = std::make_shared<t10>(R_LTiStep, C_LTiController, ptr, S_LTi_State_Machine_Non_Chemotactic, S_LTi_State_Machine_Non_Chemotactic);
	S_LTi_State_Machine_Non_Chemotactic->transitions.push_back(S_LTi_State_Machine_t10);
