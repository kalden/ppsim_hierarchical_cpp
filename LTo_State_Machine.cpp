...
LTo_State_Machine::LTo_State_Machine(
			...
			std::shared_ptr<LTo_Controller> C_LTo_Controller) :R_LTo_Step(R_LTo_Step), C_LTo_Controller(C_LTo_Controller), StateMachine("LTo_State_Machine"), expressing_RET(false), retLigandProbability(0), cell_division_clock(0)
{
