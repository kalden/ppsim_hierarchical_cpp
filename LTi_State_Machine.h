	...
	public:
		...
		class Chemotactic : public robochart::State 
		{
			public:
				...
				void Entry()
				{
					R_LTiStep->angle_to_move = calculate_angle_from_direction(R_LTiStep->chemokine_grid_direction);
				...
				class Motile : public robochart::State 
				{
					public:
						...
						void Entry()
						{
							...
							{
								S_LTi_State_Machine->probabilityOfAdhesion = Chemotactic_Walk();
							}
						}
					private:
						std::shared_ptr<LTiStep> R_LTiStep;
			...
			public:
				class Disassociated : public robochart::State 
				{
					public:
						...
						void Entry()
						{
							R_LTiStep->disassociate_cells();
							S_LTi_State_Machine->move_finished = true;
							S_LTi_State_Machine->contactedCell = false;
						}
					private:
						std::shared_ptr<LTiStep> R_LTiStep;
						std::shared_ptr<LTiController> C_LTiController;
			...
			public:
				class t0 : public robochart::Transition {
					...
					public:
						...
						{}
						bool Condition() {
							if (S_LTi_State_Machine->contactedCell == true) {
								#ifdef SM_DEBUG
			...
			public:
				class t7 : public robochart::Transition {
					...
					public:
						...
						{}
						bool Condition() {
							if (S_LTi_State_Machine->contactedCell == false && S_LTi_State_Machine->move_finished == false) {
								#ifdef SM_DEBUG
				...
				class Motile : public robochart::State 
				{
					public:
						...
						void Entry()
						{
							if (S_LTi_State_Machine->move_finished == false) 
							{
								S_LTi_State_Machine->probabilityOfAdhesion = Random_Walk();
							}
						}
					private:
						std::shared_ptr<LTiStep> R_LTiStep;
				...
				class Adhered : public robochart::State 
				{
					public:
						...
						void Entry()
						{
							if (S_LTi_State_Machine->move_finished == false) 
							{
								S_LTi_State_Machine->probabilityOfAdhesion = calculate_adhesion_probability();
							}
						}
					private:
						std::shared_ptr<LTiStep> R_LTiStep;
		...
		public:
			class t1 : public robochart::Transition {
				...
				public:
					...
					{}
					bool Condition() {
						if (S_LTi_State_Machine->contactedCell == false && S_LTi_State_Machine->T->GetCounter() > 0) {
							#ifdef SM_DEBUG
					...
					void Action() {
						R_LTiStep->high_chemokine_grid_square = measure_chemokine_expression(R_LTiStep->LTi_loc);
						S_LTi_State_Machine->chemokine_response_probability = probability_responds_to_chemokine();
					}
			};
		public:
			class t6 : public robochart::Transition {
				...
				public:
					...
					{}
					bool Condition() {
						if (S_LTi_State_Machine->contactedCell == true && S_LTi_State_Machine->adhered == true && S_LTi_State_Machine->T->GetCounter() > 0) {
							#ifdef SM_DEBUG
		...
		public:
			class t4 : public robochart::Transition {
				...
				public:
					...
					{}
					bool Condition() {
						if (S_LTi_State_Machine->contactedCell == false && R_LTiStep->chemokine_in_environment == true && S_LTi_State_Machine->T->GetCounter() > 0) {
							#ifdef SM_DEBUG
		...
		public:
			class t10 : public robochart::Transition {
				private:
					...
					std::shared_ptr<LTi_State_Machine> S_LTi_State_Machine;
				public:
					t10(std::shared_ptr<LTiStep> R_LTiStep, std::shared_ptr<LTiController> C_LTiController, std::shared_ptr<LTi_State_Machine> S_LTi_State_Machine, std::weak_ptr<robochart::State> src, std::weak_ptr<robochart::State> tgt):
					   robochart::Transition("S_LTi_State_Machine_t10", src, tgt), R_LTiStep(R_LTiStep), C_LTiController(C_LTiController), S_LTi_State_Machine(S_LTi_State_Machine)
					{}
					bool Condition() {
						if (S_LTi_State_Machine->contactedCell == false && R_LTiStep->chemokine_in_environment == false) {
							#ifdef SM_DEBUG
								printf("Condition of transition S_LTi_State_Machine_t10 is true\n");
							#endif
							return true;
						}
						else {
							#ifdef SM_DEBUG
								printf("Condition of transition S_LTi_State_Machine_t10 is false\n");
							#endif
							return false;
						}
					}
		...
		public:
			class t2 : public robochart::Transition {
				...
				public:
					...
					void Action() {
						R_LTiStep->chemokine_grid_direction = determine_movement_direction(99);
						S_LTi_State_Machine->T->SetCounter(0);
						#ifdef SM_DEBUG
							printf("Resetting Clock T\n");
						#endif
		...
		public:
			class t3 : public robochart::Transition {
				...
				public:
					...
					void Action() {
						R_LTiStep->chemokine_grid_direction = determine_movement_direction(R_LTiStep->high_chemokine_grid_square);
						S_LTi_State_Machine->T->SetCounter(0);
						#ifdef SM_DEBUG
							printf("Resetting Clock T\n");
						#endif
		...
		public:
			class t11 : public robochart::Transition {
				...
				public:
					...
					{}
					bool Condition() {
						if (S_LTi_State_Machine->contactedCell == true && S_LTi_State_Machine->T->GetCounter() > 0) {
							#ifdef SM_DEBUG
		...
		public:
			class t7 : public robochart::Transition {
				...
				public:
					...
					void Action() {
						R_LTiStep->chemokine_grid_direction = probability_responds_to_chemokine();
						S_LTi_State_Machine->T->SetCounter(0);
						#ifdef SM_DEBUG
							printf("Resetting Clock T\n");
						#endif
